...
const Cabecalho = () => {
  ...
  /* Exemplo1 de gerenciamneto de states
  Aqui, definimos no useState um valor inicial (colocado entre os parênteses do useState), além de desestruturar o state em uma variável (titulo) e em uma função (setTitulo) que será responsável por atualizar este state/titulo */
